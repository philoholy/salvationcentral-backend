...
5. Create a .env file in the root
   --> DATABASE_URL=postgresql://username:password@localhost:5432/salvationcentral

   ^^ Of course, you must decide your own username and password to fill in the blanks there.
...
8. Backend now available at http://localhost:5000
